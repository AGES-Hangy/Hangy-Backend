...
SEED_USERS = (
    UserCredentials(username="user", password="user-password"),
    UserCredentials(username="admin", password="admin-password"),
)
...
def seed_users(db: Session) -> None:
    ...
    for credentials in SEED_USERS:
        if repository.get_by_username(credentials.username) is None:
